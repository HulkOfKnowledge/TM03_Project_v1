-- =====================================================
-- DEMO SCHEMA FOR PROOF OF CONCEPT
-- =====================================================
-- Creates demo-only tables and inserts seeded data.
-- Data is isolated from production tables using the demo schema.
...
-- TABLE: demo_users
-- =====================================================
CREATE TABLE IF NOT EXISTS demo.demo_users (
...
ALTER TABLE demo.demo_users ENABLE ROW LEVEL SECURITY;

-- =====================================================
-- TABLE: demo_cards
-- =====================================================
CREATE TABLE IF NOT EXISTS demo.demo_cards (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  user_id UUID NOT NULL REFERENCES demo.demo_users(id) ON DELETE CASCADE,
...
ALTER TABLE demo.demo_cards ENABLE ROW LEVEL SECURITY;

CREATE INDEX IF NOT EXISTS idx_demo_cards_user_id ON demo.demo_cards(user_id);
CREATE INDEX IF NOT EXISTS idx_demo_cards_due_date ON demo.demo_cards(payment_due_date);

-- =====================================================
-- TABLE: demo_transactions
-- =====================================================
CREATE TABLE IF NOT EXISTS demo.demo_transactions (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  card_id UUID NOT NULL REFERENCES demo.demo_cards(id) ON DELETE CASCADE,
...
ALTER TABLE demo.demo_transactions ENABLE ROW LEVEL SECURITY;

CREATE INDEX IF NOT EXISTS idx_demo_transactions_card_id ON demo.demo_transactions(card_id);
CREATE INDEX IF NOT EXISTS idx_demo_transactions_posted_at ON demo.demo_transactions(posted_at DESC);
...
ALTER TABLE demo.demo_payments ENABLE ROW LEVEL SECURITY;

CREATE INDEX IF NOT EXISTS idx_demo_payments_card_id ON demo.demo_payments(card_id);
CREATE INDEX IF NOT EXISTS idx_demo_payments_payment_date ON demo.demo_payments(payment_date DESC);

-- =====================================================
-- TABLE: demo_recommendations
-- =====================================================
CREATE TABLE IF NOT EXISTS demo.demo_recommendations (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  user_id UUID NOT NULL REFERENCES demo.demo_users(id) ON DELETE CASCADE,
...
ALTER TABLE demo.demo_recommendations ENABLE ROW LEVEL SECURITY;

CREATE INDEX IF NOT EXISTS idx_demo_recommendations_user_id ON demo.demo_recommendations(user_id);
CREATE INDEX IF NOT EXISTS idx_demo_recommendations_priority ON demo.demo_recommendations(priority, created_at DESC);

-- =====================================================
-- SEED DATA: demo users, cards, transactions, payments, recommendations
-- =====================================================
INSERT INTO demo.demo_users (id, full_name, email, preferred_language, created_at)
VALUES
...
INSERT INTO demo.demo_transactions (id, card_id, posted_at, amount, merchant, category, type, currency, description)
VALUES
...
INSERT INTO demo.demo_payments (id, card_id, payment_date, amount, status, method, confirmation_ref)
VALUES
...
INSERT INTO demo.demo_recommendations (id, user_id, type, priority, title, message, action_required, created_at)
VALUES
  (
